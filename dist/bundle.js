...
var WEBGL_draw_buffers = function (_Extension) {
   ...
   */
  function WEBGL_draw_buffers(extName) {
    classCallCheck(this, WEBGL_draw_buffers);

    //texture attachment(color attachement
    var _this = possibleConstructorReturn(this, (WEBGL_draw_buffers.__proto__ || Object.getPrototypeOf(WEBGL_draw_buffers)).call(this, extName));
...
if (browser.firefox && parseInt(browser.firefox) >= 33 || browser.ie && parseInt(browser.ie) >= 11 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['ANGLE_instanced_arrays'] = new Extension_1('ANGLE_instanced_arrays');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 33 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['EXT_blend_minmax'] = new Extension_1('EXT_blend_minmax');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/EXT_color_buffer_float
 */
if (browser.firefox && parseInt(browser.firefox) >= 49 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['EXT_color_buffer_float'] = new Extension_1('EXT_color_buffer_float');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 30 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['EXT_color_buffer_half_float'] = new Extension_1('EXT_color_buffer_half_float');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 51 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['EXT_disjoint_timer_query'] = new Extension_1('EXT_disjoint_timer_query');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 30 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['EXT_frag_depth'] = new Extension_1('EXT_frag_depth');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 28 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['EXT_sRGB'] = new Extension_1('EXT_sRGB');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 50 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['EXT_shader_texture_lod'] = new Extension_1('EXT_shader_texture_lod');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 17 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['EXT_texture_filter_anisotropic'] = extensions1['EXT_texture_filter_anisotropic'] = new Extension_1('EXT_texture_filter_anisotropic');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 24 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['OES_element_index_uint'] = extensions1['OES_element_index_uint'] = new Extension_1('OES_element_index_uint');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 10 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['OES_standard_derivatives'] = new Extension_1('OES_standard_derivatives');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/OES_texture_float
 */
if (browser.firefox && parseInt(browser.firefox) >= 6 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['OES_texture_float'] = new Extension_1('OES_texture_float');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/OES_texture_float_linear
 */
if (browser.firefox && parseInt(browser.firefox) >= 24 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['OES_texture_float_linear'] = extensions1['OES_texture_float_linear'] = new Extension_1('OES_texture_float_linear');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/OES_texture_half_float
 */
if (browser.firefox && parseInt(browser.firefox) >= 29 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['OES_texture_half_float'] = new Extension_1('OES_texture_half_float');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/OES_texture_half_float_linear
 */
if (browser.firefox && parseInt(browser.firefox) >= 30 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['OES_texture_half_float_linear'] = extensions1['OES_texture_half_float_linear'] = new Extension_1('OES_texture_half_float_linear');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 25 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['OES_vertex_array_object'] = new Extension_1('OES_vertex_array_object');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_color_buffer_float
 */
if (browser.firefox && parseInt(browser.firefox) >= 30 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['WEBGL_color_buffer_float'] = new Extension_1('WEBGL_color_buffer_float');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 53 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_astc'] = extensions1['WEBGL_compressed_texture_astc'] = new Extension_1('WEBGL_compressed_texture_astc');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 18 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_atc'] = extensions1['WEBGL_compressed_texture_atc'] = new Extension_1('WEBGL_compressed_texture_atc');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_compressed_texture_etc
 */
if (browser.firefox && parseInt(browser.firefox) >= 51 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_etc'] = extensions1['WEBGL_compressed_texture_etc'] = new Extension_1('WEBGL_compressed_texture_etc');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_compressed_texture_etc1
 */
if (browser.firefox && parseInt(browser.firefox) >= 30 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_etc1'] = extensions1['WEBGL_compressed_texture_etc1'] = new Extension_1('WEBGL_compressed_texture_etc1');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_compressed_texture_pvrtc
 */
if (browser.firefox && parseInt(browser.firefox) >= 18 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_pvrtc'] = extensions1['WEBGL_compressed_texture_pvrtc'] = new Extension_1('WEBGL_compressed_texture_pvrtc');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 22 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_s3tc'] = extensions1['WEBGL_compressed_texture_s3tc'] = new Extension_1('WEBGL_compressed_texture_s3tc');
}
/**
...
if (browser.firefox && parseInt(browser.firefox) >= 55 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_compressed_texture_s3tc_srgb'] = extensions1['WEBGL_compressed_texture_s3tc_srgb'] = new Extension_1('WEBGL_compressed_texture_s3tc_srgb');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_debug_renderer_info
 */
if (browser.firefox && parseInt(browser.firefox) >= 53 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_debug_renderer_info'] = extensions1['WEBGL_debug_renderer_info'] = new Extension_1('WEBGL_debug_renderer_info');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_debug_shaders
 */
if (browser.firefox && parseInt(browser.firefox) >= 30 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_debug_shaders'] = extensions1['WEBGL_debug_shaders'] = new Extension_1('WEBGL_debug_shaders');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_depth_texture
 */
if (browser.firefox && parseInt(browser.firefox) >= 22 || browser.ie || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['WEBGL_debug_renderer_info'] = new Extension_1('WEBGL_debug_renderer_info');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_draw_buffers
 */
if (browser.firefox && parseInt(browser.firefox) === 28 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions1['WEBGL_draw_buffers'] = new WEBGL_draw_buffers_1('WEBGL_draw_buffers');
}
/**
 * https://developer.mozilla.org/en-US/docs/Web/API/WEBGL_lose_context
 */
if (browser.firefox && parseInt(browser.firefox) === 22 || browser.chrome && parseInt(browser.chrome) >= 47) {
  extensions2['WEBGL_lose_context'] = extensions1['WEBGL_lose_context'] = new Extension_1('WEBGL_lose_context');
}
/**
 * @class
 */
